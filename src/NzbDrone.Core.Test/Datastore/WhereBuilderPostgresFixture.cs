...
namespace NzbDrone.Core.Test.Datastore
{
    ...
    public class WhereBuilderPostgresFixture : CoreTest
    {
        ...
        public void where_in_list()
        {
            ...
            _subject.ToString().Should().Be($"(\"Artists\".\"Id\" = ANY (@Clause1_P1))");
        }
        ...
        public void where_in_list_2()
        {
            ...
            _subject.ToString().Should().Be($"((\"Artists\".\"CleanName\" = @Clause1_P1) AND (\"Artists\".\"Id\" = ANY (@Clause1_P2)))");
        }
        ...
        public void where_in_string_list_column()
        {
            ...
            _subject.ToString().Should().Be($"(@Clause1_P1 = ANY (\"ArtistMetadata\".\"OldForeignArtistIds\"))");
        }
